...
//		args = new String[]{"--help"};//"user", "platform", "dict"
//		args = new String[] {
//				"--classpath",
//				".;",
//				"--out",
//				"/Users/jiayq/Downloads/Source/anode/bridge-stub-generator/src",
//				"--mode", "user", "--verbose", "com.qhkly.base.cbk.CallbackExample" };
//		args = new String[] {
//				"--classpath",
//				".;",
//				"--out",
//				"/Users/jiayq/Downloads/Source/anode/bridge-stub-generator/src",
//				"--mode", "dict", "--verbose", "com.qhkly.base.dic.DictExample" };
		args = new String[] {
				"--classpath",
				".;",
				"--out",
				"/Users/jiayq/Downloads/Source/anode/bridge-stub-generator/src",
				"--mode", "platform", "--verbose", "com.qhkly.base.impl.PlatformImplExample" };
//		args = new String[] {
//		"--classpath",
//		".;",
//		"--out",
//		"/Users/jiayq/Downloads/Source/anode/bridge-stub-generator/src",
//		"--mode", "platform", "--verbose", "com.qhkly.base.dic.DictExample" };
